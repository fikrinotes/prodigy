...
<head>
    ...
    <title>Belajar Python | Prodigy</title>

    <!--style css-->
    <link rel="stylesheet" href="../style/style_halaman_video.css">
...
<main>
<?php
	$video = mysqli_query($conn, "SELECT * FROM video_cplusplus");
	...
	while ($link = mysqli_fetch_row($video)){ ?>
		<button class="collapsible"><?php echo $judul[$i]; $i = $i + 1; ?></button>
		<div class="content">
		<div class="tampilan-video"><iframe width="400" height="225" src="https://www.youtube.com/embed/<?php echo $link[1] ?>"></iframe></div>
		</div>
	<?php } ?>
    ...
    <!--script untuk collapse components-->
    <script>
